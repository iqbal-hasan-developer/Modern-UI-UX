  ...
  <section id='product' className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
        <img src={apple} alt="App Store" className='w-32 h-[42px] object-contain mr-5 cursor-pointer' />
        <img src={google} alt="play store" className='w-32 h-[42px] object-contain cursor-pointer' />
      </div>
    </div>
