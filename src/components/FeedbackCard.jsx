...
const FeedbackCard = ({content, name, title, img}) => (
  <div className='flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] w-full md:mr-10 sm:mr-5 mr-0 my-5 feedback-card'>
    ...
    <div className='flex flex-row'>
      ...
      <div className='flex flex-col ml-4'>
        ...
        <p className='font-poppins font-normal text-[16px] leading-6 text-dim-white'>{title}</p>
      </div>
    </div>
  </div>
)
